...
-- 2 
SELECT id_cliente, nome, email, ativo, data_cadastro FROM cliente 
    WHERE ativo = 1 AND data_cadastro > '2025-01-01' AND data_cadastro < '2025-12-31'
    LIMIT 26;
...
SELECT id_cliente, nome, email, ativo FROM cliente
	WHERE EMAIL IS NULL OR ativo = 0;

-- 2
SELECT id_produto, nome, preco, estoque FROM produto
	WHERE preco < 50 OR preco > 3000;
    
-- 3
SELECT id_pedido, id_cliente, valor, desconto FROM pedido
	WHERE desconto = 15 OR desconto = 20;
    
-- 4
SELECT id_produto, nome, preco, estoque FROM produto
	WHERE estoque < 10 OR estoque > 80;
...
-- 5 
SELECT id_cliente, nome, email FROM cliente
	WHERE email LIKE '%outlook.com' AND nome LIKE 'R%';
...
-- 2
SELECT id_cliente, nome, email, ativo FROM cliente 
	WHERE ativo<>0 AND email IS NULL;

-- 3
SELECT id_cliente, nome, email, ativo FROM cliente 
	WHERE ativo<>1 AND email IS NULL;
...
SELECT id_pedido, id_cliente, valor, desconto FROM pedido
	WHERE valor BETWEEN 2000 AND 3000;
    
-- 4 

SELECT id_cliente, nome, email, data_cadastro FROM cliente
